...
QWEN3_OMNI_FP8_COLOCATED_VIDEO_ARGS = (
    ...
    f"--preprocessing.factory.thinker_max_seq_len {QWEN3_OMNI_TP2_THINKER_MAX_SEQ_LEN} "
    f"--thinker.factory.thinker_max_seq_len {QWEN3_OMNI_TP2_THINKER_MAX_SEQ_LEN}"
)
